...
import "../interfaces/ISeiComptroller.sol";
import "../interfaces/IWrapper.sol";

/// @notice Compound-like wrapper for Sei where comptroller.markets returns (bool,uint256).
contract CompoundLikeWrapperSei is IWrapper {
    IERC20 private constant _BASE = IERC20(0x0000000000000000000000000000000000000000);
    ISeiComptroller private immutable _COMPTROLLER;
    IERC20 private immutable _CBASE;

    mapping(IERC20 => IERC20) public cTokenToToken;
    mapping(IERC20 => IERC20) public tokenTocToken;

    constructor(ISeiComptroller comptroller, IERC20 cBase) {
